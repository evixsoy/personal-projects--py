...
def action():
    ...
    for i in datelist:
        ...
        if i == daterl:
            foundplace = count
            found = 1
            print(f"{namelist[foundplace-1]}: {datelist[foundplace-1]}")
            ...
            <html>
                <body>
                    <p><strong><span style="font-size: 16px;">NAROZENINY MÁ {namelist[foundplace-1]}</span></strong></p>
